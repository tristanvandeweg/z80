...
extern unsigned char *dzx0_standard(void *src,void *dst);
extern unsigned char *dzx0_standard_callee(void *src,void *dst) __z88dk_callee;
#define dzx0_standard(a,b) dzx0_standard_callee(a,b)


extern unsigned char *dzx0_standard_back(void *src,void *dst);
extern unsigned char *dzx0_standard_back_callee(void *src,void *dst) __z88dk_callee;
#define dzx0_standard_back(a,b) dzx0_standard_back_callee(a,b)


extern unsigned char *dzx0_turbo(void *src,void *dst);
extern unsigned char *dzx0_turbo_callee(void *src,void *dst) __z88dk_callee;
#define dzx0_turbo(a,b) dzx0_turbo_callee(a,b)


extern unsigned char *dzx0_turbo_back(void *src,void *dst);
extern unsigned char *dzx0_turbo_back_callee(void *src,void *dst) __z88dk_callee;
#define dzx0_turbo_back(a,b) dzx0_turbo_back_callee(a,b)


extern unsigned char *dzx0_mega(void *src,void *dst);
extern unsigned char *dzx0_mega_callee(void *src,void *dst) __z88dk_callee;
#define dzx0_mega(a,b) dzx0_mega_callee(a,b)


extern unsigned char *dzx0_mega_back(void *src,void *dst);
extern unsigned char *dzx0_mega_back_callee(void *src,void *dst) __z88dk_callee;
#define dzx0_mega_back(a,b) dzx0_mega_back_callee(a,b)



extern unsigned char *dzx0_smart_rcs(void *src,void *dst);
extern unsigned char *dzx0_smart_rcs_callee(void *src,void *dst) __z88dk_callee;
#define dzx0_smart_rcs(a,b) dzx0_smart_rcs_callee(a,b)


extern unsigned char *dzx0_smart_rcs_back(void *src,void *dst);
extern unsigned char *dzx0_smart_rcs_back_callee(void *src,void *dst) __z88dk_callee;
#define dzx0_smart_rcs_back(a,b) dzx0_smart_rcs_back_callee(a,b)


extern unsigned char *dzx0_agile_rcs(void *src,void *dst);
extern unsigned char *dzx0_agile_rcs_callee(void *src,void *dst) __z88dk_callee;

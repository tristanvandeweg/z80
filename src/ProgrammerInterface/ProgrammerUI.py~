...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.1.0pre on Wed Jan 11 15:22:05 2023
#
...
class Licence(wx.Dialog):
	def __init__(self, *args, **kwds):
		...
		self.licence_YES.Bind(wx.EVT_BUTTON, self.OnLicenceAgree)
		self.licence_NO.Bind(wx.EVT_BUTTON, self.OnLicenceDisagree)
		self.Bind(wx.EVT_CLOSE, self.OnLicenceDisagree)
		# end wxGlade
